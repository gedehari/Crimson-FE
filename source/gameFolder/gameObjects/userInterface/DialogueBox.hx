...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		box = new FlxSprite(120, 300);
		
		var hasDialog = false;

		hasDialog = true;
		box.frames = Paths.getSparrowAtlas("UI/default/base/speech_bubble_talking");
		...
		portraitLeft.frames = Paths.getSparrowAtlas('dialogue/CrimPortrait');
